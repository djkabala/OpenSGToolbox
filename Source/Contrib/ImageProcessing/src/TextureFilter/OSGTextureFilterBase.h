...
#include "OSGSysFields.h"               // InternalDirty type
...
class OSG_CONTRIBIMAGEPROCESSING_DLLMAPPING TextureFilterBase : public AttachmentContainer
{
  public:
    ...
    OSG_GEN_INTERNALPTR(TextureFilter);
  ...
  public:
    ...
    static const OSG::BitVector InternalDirtyFieldMask =
        (TypeTraits<BitVector>::One << InternalDirtyFieldId);
    static const OSG::BitVector NextFieldMask =
        (TypeTraits<BitVector>::One << NextFieldId);
        
    typedef SFBool            SFInternalDirtyType;
  ...
  protected:
    ...
    GetFieldHandlePtr  getHandleInternalDirty   (void) const;
    EditFieldHandlePtr editHandleInternalDirty  (void);
    ...
    /*! \{                                                                 */
            ...
            const SFBool              *getSFInternalDirty   (void) const;
                  ...
                  bool                 getInternalDirty   (void) const;
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      TextureFilterBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
