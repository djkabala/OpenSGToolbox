...
inline
OSG::UInt16 TextureFilterBase::getClassGroupId(void)
{
...
//! Get the value of the TextureFilter::_sfInternalDirty field.
inline
      bool  TextureFilterBase::getInternalDirty(void) const
{
    return _sfInternalDirty.getValue();
}
...
inline
void TextureFilterBase::execSync (      TextureFilterBase *pFrom,
                                  ...
                                  const UInt32             uiSyncInfo)
{
    ...
    if(FieldBits::NoField != (InternalDirtyFieldMask & whichField))
        _sfInternalDirty.syncWith(pFrom->_sfInternalDirty);
}
#endif


inline
const Char8 *TextureFilterBase::getClassname(void)
{
