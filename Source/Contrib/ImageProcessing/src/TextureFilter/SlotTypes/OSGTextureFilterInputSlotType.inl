...
inline
TextureFilter* const TextureFilterInputSlot::getSourceFilter(void) const
{
...
inline
void TextureFilterInputSlot::setSourceFilter(TextureFilter* const value)
{
    _SourceFilter = value;
}
