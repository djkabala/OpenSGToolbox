...
inline
const TextureFilterOutputSlot::OutSlotVec& TextureFilterOutputSlot::getSinkFilters(void) const
{
    return _SinkFilters;
}
inline
TextureFilter* TextureFilterOutputSlot::getSinkFilter(UInt32 Index) const
{
