...
#include "OSGTable.h"                   // ParentTable Class
...
/*! \var Table *         AbstractElementBase::_sfParentTable
...
void AbstractElementBase::classDescInserter(TypeObject &oType)
{
    ...
    pDesc = new SFUnrecTablePtr::Description(
        ...
        "ParentTable",
        "",
        ParentTableFieldId, ParentTableFieldMask,
        false,
        (Field::SFDefaultFlags | Field::FStdAccess),
        static_cast<FieldEditMethodSig>(&AbstractElement::editHandleParentTable),
        static_cast<FieldGetMethodSig >(&AbstractElement::getHandleParentTable));
...
//! Get the AbstractElement::_sfParentTable field.
const SFUnrecTablePtr *AbstractElementBase::getSFParentTable(void) const
{
    return &_sfParentTable;
}

SFUnrecTablePtr     *AbstractElementBase::editSFParentTable    (void)
{
    editSField(ParentTableFieldMask);
...
UInt32 AbstractElementBase::getBinSize(ConstFieldMaskArg whichField)
{
    ...
    if(FieldBits::NoField != (ParentTableFieldMask & whichField))
    {
        returnValue += _sfParentTable.getBinSize();
    }
                                    ...
                                    ConstFieldMaskArg  whichField)
{
    ...
    if(FieldBits::NoField != (ParentTableFieldMask & whichField))
    {
        _sfParentTable.copyFromBin(pMem);
    }
}
...
void AbstractElementBase::onCreate(const AbstractElement *source)
{
    ...
    if(source != NULL)
    {
        ...
        pThis->setParentTable(source->getParentTable());
    }
}

GetFieldHandlePtr AbstractElementBase::getHandleParentTable     (void) const
{
    SFUnrecTablePtr::GetHandlePtr returnValue(
        new  SFUnrecTablePtr::GetHandle(
             &_sfParentTable,
             this->getType().getFieldDesc(ParentTableFieldId),
             const_cast<AbstractElementBase *>(this)));

    return returnValue;
}

EditFieldHandlePtr AbstractElementBase::editHandleParentTable    (void)
{
    ...
    returnValue->setSetMethod(
        boost::bind(&AbstractElement::setParentTable,
...
void AbstractElementBase::resolveLinks(void)
{
    ...
    static_cast<AbstractElement *>(this)->setParentTable(NULL);
