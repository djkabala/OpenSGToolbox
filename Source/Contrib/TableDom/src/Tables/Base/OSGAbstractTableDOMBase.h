...
#ifndef _OSGABSTRACTTABLEDOMBASE_H_
#define _OSGABSTRACTTABLEDOMBASE_H_
#ifdef __sgi
#pragma once
#endif
...
//! \brief AbstractTableDOM Base Class.

class OSG_CONTRIBTABLEDOM_DLLMAPPING AbstractTableDOMBase : public TableDOM
{
  public:

    typedef TableDOM Inherited;
    typedef TableDOM ParentContainer;

    typedef Inherited::TypeObject TypeObject;
    typedef TypeObject::InitPhase InitPhase;

    OSG_GEN_INTERNALPTR(AbstractTableDOM);
  ...
  protected:
    ...
    AbstractTableDOMBase(void);
    AbstractTableDOMBase(const AbstractTableDOMBase &source);
    ...
    virtual ~AbstractTableDOMBase(void);
    ...
    virtual void execSyncV(      FieldContainer    &oFrom,
            ...
            void execSync (      AbstractTableDOMBase *pFrom,
                                 ConstFieldMaskArg  whichField,
                                 AspectOffsetStore &oOffsets,
                                 ConstFieldMaskArg  syncMode  ,
                           const UInt32             uiSyncInfo);
  ...
  private:
    ...
    void operator =(const AbstractTableDOMBase &source);
};

typedef AbstractTableDOMBase *AbstractTableDOMBaseP;

OSG_END_NAMESPACE

#endif /* _OSGABSTRACTTABLEDOMBASE_H_ */
