...
DataType FieldTraits<Table *>::_type("TablePtr", "AttachmentContainerPtr");
#endif
...
//! Table Produced Events

EventDescription *TableBase::_eventDesc[] =
{
    new EventDescription("Changed", 
                          "",
                          ChangedEventId, 
                          FieldTraits<TableEventDetails *>::getType(),
                          true,
                          static_cast<EventGetMethod>(&TableBase::getHandleChangedSignal)),
    ...
    new EventDescription("Insert", 
                          ...
                          FieldTraits<TableEventDetails *>::getType(),
                          true,
                          static_cast<EventGetMethod>(&TableBase::getHandleInsertSignal)),
    ...
    new EventDescription("Remove", 
                          ...
                          FieldTraits<TableEventDetails *>::getType(),
                          true,
                          static_cast<EventGetMethod>(&TableBase::getHandleRemoveSignal)),
    ...
    new EventDescription("UndoableEditHappened", 
                          ...
                          true,
                          static_cast<EventGetMethod>(&TableBase::getHandleUndoableEditHappenedSignal))

};

EventProducerType TableBase::_producerType(
    "TableProducerType",
    "EventProducerType",
    "",
...
const EventProducerType &TableBase::getProducerType(void) const
{
...
/*------------------------- event producers ----------------------------------*/
void TableBase::produceEvent(UInt32 eventId, EventDetails* const e)
{
    switch(eventId)
    {
    case ChangedEventId:
...
boost::signals2::connection TableBase::connectEvent(UInt32 eventId, 
...
void  TableBase::disconnectEvent(UInt32 eventId, const BaseEventType::group_type &group)
{
    switch(eventId)
    {
    case ChangedEventId:
...
void  TableBase::disconnectAllSlotsEvent(UInt32 eventId)
{
    switch(eventId)
    {
    case ChangedEventId:
...
bool  TableBase::isEmptyEvent(UInt32 eventId) const
{
    switch(eventId)
    {
    case ChangedEventId:
...
UInt32  TableBase::numSlotsEvent(UInt32 eventId) const
{
    switch(eventId)
    {
    case ChangedEventId:
...
GetEventHandlePtr TableBase::getHandleChangedSignal(void) const
{
...
GetEventHandlePtr TableBase::getHandleInsertSignal(void) const
{
    GetEventHandlePtr returnValue(
...
GetEventHandlePtr TableBase::getHandleRemoveSignal(void) const
{
    GetEventHandlePtr returnValue(
...
GetEventHandlePtr TableBase::getHandleUndoableEditHappenedSignal(void) const
{
    GetEventHandlePtr returnValue(
