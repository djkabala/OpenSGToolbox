...
class OSG_CONTRIBTABLEDOM_DLLMAPPING TableBase : public AttachmentContainer
{
  public:
    ...
    typedef TableEventDetails  ChangedEventDetailsType;
    typedef TableEventDetails  InsertEventDetailsType;
    typedef TableEventDetails  RemoveEventDetailsType;
    typedef UndoableEditEventDetails UndoableEditHappenedEventDetailsType;

    typedef boost::signals2::signal<void (EventDetails* const            , UInt32)> BaseEventType;
    typedef boost::signals2::signal<void (TableEventDetails* const, UInt32), ConsumableEventCombiner> ChangedEventType;
    typedef boost::signals2::signal<void (TableEventDetails* const, UInt32), ConsumableEventCombiner> InsertEventType;
    typedef boost::signals2::signal<void (TableEventDetails* const, UInt32), ConsumableEventCombiner> RemoveEventType;
