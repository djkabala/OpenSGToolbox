...
/*! \brief FixedHeightLayoutManager class. See \ref
           PageContribTableDomFixedHeightLayoutManager for a description.
*/

class OSG_CONTRIBTABLEDOM_DLLMAPPING FixedHeightLayoutManager : public FixedHeightLayoutManagerBase
{
  protected:
