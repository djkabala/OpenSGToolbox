...
#include "OSGColorChooserComboBoxComponentGenerator.h"
...
// OSGColorChooserComboBoxComponentGeneratorBase.cpp file.
// To modify it, please change the .fcd file (OSGColorChooserComboBoxComponentGenerator.fcd) and
